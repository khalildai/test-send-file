...
Set-Content -LiteralPath $logPath -Value "V2.0.26d1 temp demo startup log - $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')" -Encoding UTF8
$env:PYTHONUTF8 = '1'
$env:MATURITY_PORT = '5001'
...
try {
    ...
    Write-Step '[3/3] Starting V2.0.26d1 temp demo service...'
