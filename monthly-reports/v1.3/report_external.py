...
story.append(Table([[bar_chart("内部领域达成率（当前快照）", domain_labels, domain_rates, width=330, height=165), radar_chart("内部成熟度雷达", domain_labels, domain_rates, width=205, height=165)]], colWidths=[94*mm, 80*mm], style=TableStyle([("VALIGN", (0,0),(-1,-1),"TOP"), ("LEFTPADDING", (0,0),(-1,-1),0), ("RIGHTPADDING", (0,0),(-1,-1),0)])))
...
story.append(four)
story.append(Spacer(1, 5*mm)); story.append(P("三、整体研发效能与分析口径", "H"))
scope_rows = [[P("模块", "CW"), P("本版展示内容", "CW"), P("数据口径", "CW")], [P("样本与口径", "C"), P("组织、科组、能力项、领域、评估维度和等级分布", "C"), P("V2.0.13 只读快照；组织关系按当前关联计算", "C")], [P("整体研发效能", "C"), P("总体达成率、年度目标差距、领域结构和组织覆盖", "C"), P("成熟度能力项达成结果；历史趋势暂不虚构", "C")], [P("交付效率", "C"), P("已达成能力项数量、组织覆盖率、领域推进情况", "C"), P("用于展示的假数据代理，不代表研发交付周期", "C")], [P("交付质量", "C"), P("能力项达成、未达成缺口、短板收敛情况", "C"), P("成熟度结果代理；不含缺陷、逃逸率、回退数据", "C")], [P("工程效率与流程", "C"), P("评估维度覆盖、等级跃迁、自动化相关能力项", "C"), P("按能力模型记录分析，不扩展到外部执行系统", "C")], [P("组织协同与度量", "C"), P("业务/部门/科组排名、优势短板、改进责任", "C"), P("按组织关联科组聚合；同分并列", "C")], [P("基准对标", "C"), P("年度目标 3.0 分、目标差距和相对排名", "C"), P("内部目标线；外部 P50/P75/P90 不填未核验值", "C")]]
...
story.append(scope); story.append(Spacer(1, 4*mm)); story.append(P("高绩效团队洞察（内部代理）：优先关注领域覆盖完整、2/3/4 级能力连续达成、跨组织关联清晰且短板项较少的科组；该结论用于成熟度改进，不等同于外部研发效能排名。", "B"))
